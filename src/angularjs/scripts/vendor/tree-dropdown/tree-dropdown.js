 ...
 */
 ...
 function treeDropdown($compile){
     var template = "<div class='select' ng-click='openTree()'><p style='white-space: nowrap;overflow: hidden !important';text-overflow: ellipsis;'>{{selected.isDepartment ? selected.name : selected.fullyQualifiedName}}</p></div>";
     ...
     function getOptions(scope, data, level){
         ...
         var optionUL = angular.element("<ul id='filterCatListUl'></ul>");
