            ...
            link: function ($scope, element, attrs) {
                ...
                $scope.createTooltip = function (event) {
                    if (attrs.ptitle || attrs.tooltip) {
                        ...
                        $scope.updateTooltip(attrs.ptitle || attrs.tooltip);

                        // fade in
                        $scope.tooltipElement.addClass('angular-tooltip-fade-in');
                       // angular.element(document).find('body').css({overflow: "hidden", height: "100%" });
                    }
                };

                $scope.updateTooltip = function(ptitle) {
                    // insert html into tooltip
                    $scope.tooltipElement.html(ptitle);
                ...
                $scope.removeTooltip = function () {
                    ...
                    // $timeout(function() {
                        tooltip.remove();
                    // }, 300);
                   // angular.element(document).find('body').css({overflow: "inherit", height: "inherit" });
                };
